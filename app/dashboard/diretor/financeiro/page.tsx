  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-gray-950">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 border border-[#1E3A5F] dark:border-blue-400 text-[#1E3A5F] dark:text-blue-400 px-4 py-2 rounded-xl text-sm font-medium hover:bg-blue-50 dark:hover:bg-blue-950"
            >
              <Plus size={16} />
              Lançamento
            </button>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex gap-2 mb-6 bg-white dark:bg-gray-900 rounded-xl p-1 border border-gray-100 dark:border-gray-800 w-fit">
          {(['resumo', 'inadimplentes', 'fluxo'] as const).map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors capitalize ${activeTab === tab ? 'bg-[#1E3A5F] text-white' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}
            >
          ...
          <div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Receita total</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Total de despesas</p>
              </div>

              <div className={`rounded-2xl p-6 border ${report.summary.balance >= 0 ? 'bg-green-50 dark:bg-green-950 border-green-100 dark:border-green-800' : 'bg-red-50 dark:bg-red-950 border-red-100 dark:border-red-800'}`}>
                <div className="w-10 h-10 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center mb-4">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Saldo do mês</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Em atraso</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Pendente</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Taxa de inadimplência</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
            {defaulters.length === 0 ? (
              <div className="p-8 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">Nenhum inadimplente!</p>
              </div>
            ) : (
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                  <tr>
                    ...
                    <th className="text-left px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase hidden sm:table-cell">Dias em atraso</th>
                  </tr>
                </thead>
                    ...
                    <tr key={d.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-medium text-gray-700 dark:text-gray-200">{d.student}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 hidden sm:table-cell">
                        <span className="text-sm text-gray-500 dark:text-gray-400">{d.reference}</span>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 hidden sm:table-cell">
                        <span className="text-xs px-2 py-1 bg-red-50 dark:bg-red-950 text-red-700 rounded-full font-medium">
                          {d.daysOverdue} dias
                        </span>
                      </td>
                    </tr>
        ...
        {activeTab === 'fluxo' && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
            {cashflows.length === 0 ? (
              <div className="p-8 text-center">
                <p className="text-gray-400 dark:text-gray-500 text-sm">Nenhum lançamento registrado.</p>
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Use o botão "Lançamento" para registrar entradas e saídas.</p>
              </div>
            ) : (
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                  <tr>
                    <th className="text-left px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Data</th>
                    <th className="text-left px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase hidden sm:table-cell">Descrição</th>
                    <th className="text-left px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Tipo</th>
                    <th className="text-right px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Valor</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
                  {cashflows.map((cf) => (
                    <tr key={cf.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <td className="px-6 py-4 hidden sm:table-cell">
                        <span className="text-sm text-gray-700 dark:text-gray-200">{cf.description}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className={`text-xs px-2 py-1 rounded-full font-medium ${cf.type === 'income' ? 'bg-green-50 dark:bg-green-950 text-green-700' : 'bg-red-50 dark:bg-red-950 text-red-700'}`}>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-md p-6">
            <h2 className="text-lg font-bold text-[#1E3A5F] dark:text-white mb-4">Nova mensalidade</h2>
            <form onSubmit={handleCreateTuition} className="space-y-3">
              ...
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={() => setShowModal(false)} className="flex-1 py-3 rounded-xl border border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800">Cancelar</button>
      ...
      {showCashFlowModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-md p-6">
            <h2 className="text-lg font-bold text-[#1E3A5F] dark:text-white mb-4">Novo lançamento</h2>
            <form onSubmit={handleCreateCashFlow} className="space-y-3">
              ...
              {error && <p className="text-red-500 dark:text-red-400 text-xs">{error}</p>}
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={() => setShowCashFlowModal(false)} className="flex-1 py-3 rounded-xl border border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800">Cancelar</button>
                <button type="submit" disabled={saving} className="flex-1 py-3 rounded-xl bg-[#1E3A5F] text-white text-sm font-medium hover:bg-[#162d4a] disabled:opacity-50">
