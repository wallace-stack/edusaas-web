    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-gray-950">
      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">Painel do Diretor</span>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Aqui está o resumo da sua escola hoje.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
            ...
            <p className="text-3xl font-bold text-[#1E3A5F] dark:text-white">{data?.people.totalStudents || 0}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Alunos</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
            ...
            <p className="text-3xl font-bold text-[#1E3A5F] dark:text-white">{data?.people.totalTeachers || 0}</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
            ...
            <p className="text-3xl font-bold text-[#1E3A5F] dark:text-white">{data?.people.totalCoordinators || 0}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Coordenadores</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
            ...
            <p className="text-3xl font-bold text-[#1E3A5F] dark:text-white">{data?.academic.avgGrade || 0}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Média geral das notas</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
            ...
            <p className="text-3xl font-bold text-[#1E3A5F] dark:text-white">{data?.academic.avgAttendance || '0%'}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Frequência média</p>
          </div>

          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
            <div className="w-10 h-10 bg-emerald-50 dark:bg-emerald-950 rounded-xl flex items-center justify-center mb-4">
              <DollarSign size={20} className="text-emerald-600" />
            </div>
            <p className="text-3xl font-bold text-[#1E3A5F] dark:text-white">
        ...
        {data && data.financial.totalOverdueTuitions > 0 && (
          <div className="bg-red-50 dark:bg-red-950 border border-red-100 dark:border-red-800 rounded-2xl p-4 flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-red-500 dark:text-red-400">Taxa de inadimplência: {data.financial.defaultRate}</p>
            </div>
            <button
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { label: 'Usuários', icon: Users, href: '/dashboard/diretor/usuarios', color: 'bg-blue-50 dark:bg-blue-950 text-blue-600' },
            { label: 'Turmas', icon: BookOpen, href: '/dashboard/diretor/turmas', color: 'bg-purple-50 dark:bg-purple-950 text-purple-600' },
            { label: 'Financeiro', icon: DollarSign, href: '/dashboard/diretor/financeiro', color: 'bg-emerald-50 dark:bg-emerald-950 text-emerald-600' },
            { label: 'Notificações', icon: Bell, href: '/dashboard/diretor/notificacoes', color: 'bg-orange-50 dark:bg-orange-950 text-orange-600' },
          ].map((item) => (
            <button
              key={item.label}
