...
export default function DiretorNotificacoesPage() {
    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-gray-950">
      <header className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center gap-3">
          ...
          <h1 className="font-bold text-[#1E3A5F] dark:text-white">Notificações</h1>
        </div>
      </header>

      <main className="max-w-3xl mx-auto px-6 py-16 flex flex-col items-center text-center">
        <div className="w-20 h-20 bg-orange-50 dark:bg-orange-950 rounded-2xl flex items-center justify-center mb-6">
