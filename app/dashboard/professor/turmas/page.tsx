      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {classes.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <h3 className="font-medium text-lg text-gray-700 dark:text-gray-200 mb-1">Você não tem turmas atribuídas</h3>
            <p className="text-sm text-gray-400 dark:text-gray-500 max-w-xs">
              Fale com a coordenação para ser alocado em uma turma.
            </p>
          </div>
        ) : (
              ...
              <div key={c.id} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 hover:shadow-sm transition-shadow">
                ...
                <div className="grid grid-cols-2 gap-2 pt-3 border-t border-gray-50 dark:border-gray-800">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 min-h-[40px] py-2.5 rounded-xl bg-green-50 dark:bg-green-950 text-green-600 text-sm font-medium hover:bg-green-100 dark:hover:bg-green-900 active:scale-[0.97] transition-all"
                  >
                    <CheckSquare size={15} />
                    Chamada
                  </button>
